...
function initGame() {
	...
	moves = 0;
	$moveNum.text('0');
	$ratingStars.removeClass('fa-star-o').addClass('fa-star'); //set initial star rating to blank
	for (let card of cards) {
		$deck.append($('<li class="card"><i class="fa fa-' + card + '"></i></li>')) //this block creates the deck
	}
	addCardListener();
...
function setRating(moves) {
	...
	if (moves > rank3stars && moves < rank2stars) {
		...
		rating = 2;
	} else if ((moves > rank2stars && moves < rank1stars) || (moves > rank1stars)) {
